...
public final class ServerTransactionalIntegrationTest
{
  ...
  public static class DefaultServiceImpl
  ...
  public static class RequiresNewServiceImpl
    implements RequiresNewService
  {
    @Override
    public void run()
    {
  ...
  public static class TestTransactionManager
  ...
  @Injector( includes = { DefaultServiceImpl.class, TestTransactionManager.class }, fragmentOnly = false )
  ...
  @Injector( includes = { RequiresNewServiceImpl.class, TestTransactionManager.class }, fragmentOnly = false )
