...
public final class InterceptorsIntegrationTest {
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.TraceInterceptor",
            priority = 100)
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.InnerInterceptor",
            priority = 150)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.OuterAroundInterceptor",
            priority = 40)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.InnerAroundInterceptor",
            priority = 140)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    public static class AroundServiceImpl implements AroundService {
        @Nonnull
        @Override
    ...
    public static class ConstructorConsumerImpl implements ConstructorConsumer {
        @Nonnull
    ...
    public static class ImplBoundServiceImpl implements ImplBoundService {
        @Override
        public void ping() {
    ...
    public static class ProviderBoundServiceImpl implements ProviderBoundService {
        @Override
        public void ping() {
    ...
    public static class MultiServiceImpl implements MultiA, MultiB {
        @Override
        public void callA() {
    ...
    public static class LeftQualifiedService implements QualifiedService {
        @Nonnull
        @Override
        public String name() {
            return "left";
    ...
    @Injectable
    @Typed(QualifiedService.class)
    public static class RightQualifiedService implements QualifiedService {
        @Nonnull
        @Override
        public String name() {
            return "right";
    ...
    public static class OverrideServiceImpl implements OverrideService {
        @Override
        public void run() {
    ...
    public static class SupplierCycleServiceImpl implements SupplierCycleService {
        @Override
        public void run() {
    ...
    public static class EagerServiceImpl implements EagerService {
        EagerServiceImpl() {
    ...
    public static class TraceInterceptor {
        ...
        public void afterException(
                @MethodName @Nonnull final String methodName, @Thrown @Nonnull final Throwable throwable) {
    ...
    public static class OuterAroundInterceptor {
        ...
        public Object around(
                @Proceed @Nonnull final Invocation invocation,
                @ServiceType @Nonnull final String serviceType,
                @MethodName @Nonnull final String methodName,
                @BindingValue("value") @Nonnull final String binding,
                @Arguments @Nonnull final Object[] arguments)
                throws Throwable {
            return InterceptorsIntegrationTest.around(
                    "outerAround", c_outerAroundMode, invocation, serviceType, methodName, binding, arguments);
        }
    ...
    public static class InnerAroundInterceptor {
        ...
        public Object around(
                ...
                throws Throwable {
            return InterceptorsIntegrationTest.around(
                    "innerAround", c_innerAroundMode, invocation, serviceType, methodName, binding, arguments);
        }
    ...
    private static Object around(
            ...
            throws Throwable {
        c_trace.add(name + ":around:enter:" + serviceType.substring(serviceType.lastIndexOf('.') + 1) + "." + methodName
                + ":" + binding + ":" + Arrays.toString(arguments));
        return switch (mode) {
    ...
    private static Object proceed(@Nonnull final String name, @Nonnull final Invocation invocation) throws Throwable {
        try {
            final Object result = invocation.proceed();
    ...
    private static Object proceed(
            @Nonnull final String name, @Nonnull final Invocation invocation, @Nonnull final Object[] arguments)
            throws Throwable {
        try {
    ...
    @Injectable
    public static class OverrideInterceptor extends BaseOverrideInterceptor {
        OverrideInterceptor() {}
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.OverrideInterceptor",
            priority = 100)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.SupplierCycleInterceptor",
            priority = 100)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    @InterceptorBinding(
            implementedBy = "sting.integration.InterceptorsIntegrationTest.EagerInterceptor",
            priority = 100)
    @Retention(RetentionPolicy.CLASS)
    @Target({ElementType.TYPE, ElementType.METHOD})
    ...
    public void ownAroundFailureBeforeProceedIsObservedByOwnAfterExceptionAndOuter() {
        ...
        final IllegalStateException exception = expectThrows(
                ...
                () -> AroundInjector.create().service().echo("a"));
    ...
    public void innerFailureThroughProceedIsObservedByOuterAround() {
        ...
        final IllegalStateException exception = expectThrows(
                IllegalStateException.class,
                () -> AroundInjector.create().service().runtime());
    ...
    public void replacementArgumentValidation() {
        ...
        expectThrows(
                AssertionError.class, () -> AroundInjector.create().service().replace("original", 1));
    ...
    public void varargsReplacementUsesFormalParameterCount() {
        ...
        expectThrows(
                AssertionError.class, () -> AroundInjector.create().service().varargs("p", "a"));
    }
    ...
    public void wrongReplacementElementTypesFailNaturally() {
        ...
        expectThrows(
                ...
                () -> AroundInjector.create().service().replace("original", 1));

        resetAroundState();
        c_outerAroundMode = AroundMode.NULL_PRIMITIVE_REPLACEMENT;
        expectThrows(
                NullPointerException.class,
                () -> AroundInjector.create().service().primitiveArg(1));
    }
    ...
    public void primitiveAroundReturnHandling() {
        ...
        expectThrows(
                NullPointerException.class,
                () -> AroundInjector.create().service().primitive("abc"));
    ...
    public void declaredCheckedExceptionFromAroundIsRethrown() {
        ...
        final IOException exception = expectThrows(
                IOException.class, () -> AroundInjector.create().service().checked());
    ...
    public void undeclaredCheckedThrowableFromAroundIsWrappedAtProxyBoundary() {
        ...
        final UndeclaredThrowableException exception = expectThrows(
    ...
    public void runtimeExceptionAndErrorFromAroundRethrowUnchanged() {
        ...
        final IllegalStateException runtime = expectThrows(
                IllegalStateException.class,
                () -> AroundInjector.create().service().echo("a"));
        ...
        final AssertionError error = expectThrows(
                AssertionError.class, () -> AroundInjector.create().service().echo("a"));
    ...
    public void lifecycleAroundSuccessfulCall() {
        ...
        assertEquals(c_trace, List.of("before:MyService.ok:service:1", "target:a", "after:ok:ok:a"));
    }
    ...
    public void lifecycleAroundCheckedException() {
        ...
        assertEquals(c_trace, List.of("before:MyService.fail:service:0", "target:fail", "exception:fail:IOException"));
    }
    ...
    public void priorityOrdering() {
        ...
        assertEquals(c_trace, List.of("outer:before", "inner:before", "target:ordered", "inner:after", "outer:after"));
    }
    ...
    public void requestKindsReturnCachedProxy() {
        ...
        assertSame(
                injector.optionalServiceSupplierCollection()
                        .iterator()
                        .next()
                        .get()
                        .orElseThrow(),
    ...
    public void bindingSourceAnnotationsAreApplied() {
        ...
        assertEquals(
                c_trace,
                List.of("before:ImplBoundService.ping:implementation:0", "target:implBound", "after:ping:null"));

        c_trace.clear();
        MyInjector.create().providerBoundService().ping();
        assertEquals(
                c_trace,
                List.of("before:ProviderBoundService.ping:provider:0", "target:providerBound", "after:ping:null"));
    }
    ...
    public void ownBeforeFailureIsOnlyObservedByOuterInterceptor() {
        ...
        try {
            ...
            assertEquals(c_trace, List.of("outer:before", "inner:before", "outer:exception:inner-before"));
        } finally {
            c_innerBeforeThrows = false;
        }
    }
    ...
    public void subclassOverrideRedeclaringLifecycleAnnotationRuns() {
        ...
        assertEquals(c_trace, List.of("override:before", "target:override"));
    }
    ...
    public void factoryInterfaceIsInterceptedAtSynchronousCallBoundary() {
        ...
        assertEquals(
                c_trace,
                List.of("before:GeneratedFactory.create:factory:1", "target:factory:made", "after:create:made"));
    }
    ...
    public void asyncShapedReturnIsInterceptedAtSynchronousBoundaryOnly() {
        ...
        assertEquals(List.of("before:AsyncService.start:async:0", "target:async", "after:start:" + handle), c_trace);

        handle.complete();
        assertEquals(
                List.of(
                        "before:AsyncService.start:async:0",
                        "target:async",
                        "after:start:" + handle,
                        "handle:complete"),
                c_trace);
    ...
    public void supplierBoundaryCycleReceivesProxyWhenInvoked() {
        ...
        service.run();
        assertEquals(c_trace, List.of("supplierCycle:before", "target:supplierCycle"));
    }
}
