...
const siteConfig = {
  ...
  /* colors for website */
  colors: {
    /* This is derived from https://coolors.co/ffffff-ffddad-86cb95-3e885b-050505 */
    primaryColor: '#050505',
  ...
  repoUrl: 'https://github.com/sting-ioc/sting',
  editUrl: 'https://github.com/sting-ioc/sting/tree/master/docs/',
  markdownPlugins: [
    embed.hook
  ]
};
