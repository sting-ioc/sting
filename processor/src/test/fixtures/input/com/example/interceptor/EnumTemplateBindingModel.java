...
public final class EnumTemplateBindingModel
{
  ...
  @Injector( includes = { DefaultModel.class, OtherModel.class, RequiresNewModel.class, ThirdPartyModel.class },
             fragmentOnly = false )
