...
final class Sting_SupplierBrokenDirectCircularDependencyModel
    implements SupplierBrokenDirectCircularDependencyModel {
  @Nullable
  ...
  private synchronized Object node1() {
    if (null == node1) {
      node1 = Objects.requireNonNull(
          SupplierBrokenDirectCircularDependencyModel_Sting_MyModel2.create(() -> node2()));
    }
    assert null != node1;
    return node1;
  }
  ...
  private synchronized Object node2() {
    if (null == node2) {
      node2 = Objects.requireNonNull(
          SupplierBrokenDirectCircularDependencyModel_Sting_MyModel1.create(node1()));
    }
    assert null != node2;
    return node2;
  }
