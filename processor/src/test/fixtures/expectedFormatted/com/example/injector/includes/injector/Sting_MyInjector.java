...
final class Sting_MyInjector implements MyInjector {
  @Nonnull
  private final Sting_Sting_MyOtherInjectorModel_Provider fragment1 =
      new Sting_Sting_MyOtherInjectorModel_Provider();

  @Nonnull
  private final Sting_Sting_MyOtherInjectorModel_Provider fragment2 =
      new Sting_Sting_MyOtherInjectorModel_Provider();
