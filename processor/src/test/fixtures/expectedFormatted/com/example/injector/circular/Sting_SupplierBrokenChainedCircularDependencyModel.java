...
final class Sting_SupplierBrokenChainedCircularDependencyModel
    implements SupplierBrokenChainedCircularDependencyModel {
  @Nullable
  ...
  private synchronized Object node1() {
    if (null == node1) {
      node1 = Objects.requireNonNull(
          SupplierBrokenChainedCircularDependencyModel_Sting_MyModel2.create(node3()));
    }
    assert null != node1;
    return node1;
  }
  ...
  private synchronized Object node2() {
    if (null == node2) {
      node2 = Objects.requireNonNull(
          SupplierBrokenChainedCircularDependencyModel_Sting_MyModel1.create(node1()));
    }
    assert null != node2;
    return node2;
  }
  ...
  private synchronized Object node3() {
    if (null == node3) {
      node3 = Objects.requireNonNull(
          SupplierBrokenChainedCircularDependencyModel_Sting_MyModel3.create(() -> node2()));
    }
    assert null != node3;
    return node3;
  }
