...
final class Sting_BasicEagerDependencyModel implements BasicEagerDependencyModel {
  ...
  Sting_BasicEagerDependencyModel() {
    ...
    node5 = Objects.requireNonNull(
        BasicEagerDependencyModel_Sting_MyModel4.create(node1, () -> node3(), () -> node4));
    node6 = Objects.requireNonNull(
        BasicEagerDependencyModel_Sting_MyModel5.create(node1, () -> node3(), node4));
    node7 = Objects.requireNonNull(BasicEagerDependencyModel_Sting_MyModel6.create(node5, node6));
  }
  ...
  private synchronized Object node3() {
    if (null == node3) {
      node3 =
          Objects.requireNonNull(BasicEagerDependencyModel_Sting_MyModel3.create(node2(), node1));
    }
    assert null != node3;
    return node3;
  }
