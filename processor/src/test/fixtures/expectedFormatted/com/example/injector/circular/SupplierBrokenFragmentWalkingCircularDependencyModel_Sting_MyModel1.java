...
public final class SupplierBrokenFragmentWalkingCircularDependencyModel_Sting_MyModel1 {
  ...
  public static Object create(final Object model) {
    return new SupplierBrokenFragmentWalkingCircularDependencyModel.MyModel1(Objects.requireNonNull(
        (SupplierBrokenFragmentWalkingCircularDependencyModel.MyModel2) model));
  }
}
