...
final class Sting_PrimitiveOutputModel implements PrimitiveOutputModel {
  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment1 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment2 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment3 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment4 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment5 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment6 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment7 =
      new PrimitiveOutputModel_Sting_MyFragment();

  @Nonnull
  private final PrimitiveOutputModel_Sting_MyFragment fragment8 =
      new PrimitiveOutputModel_Sting_MyFragment();
