...
final class Sting_SupplierBrokenFragmentWalkingCircularDependencyModel
    implements SupplierBrokenFragmentWalkingCircularDependencyModel {
  @Nonnull
  private final SupplierBrokenFragmentWalkingCircularDependencyModel_Sting_MyFragment fragment1 =
      new SupplierBrokenFragmentWalkingCircularDependencyModel_Sting_MyFragment();
  ...
  private synchronized Object node1() {
    if (null == node1) {
      node1 = Objects.requireNonNull(
          SupplierBrokenFragmentWalkingCircularDependencyModel_Sting_MyModel2.create(node3()));
    }
    assert null != node1;
    return node1;
  }
  ...
  private synchronized Object node2() {
    if (null == node2) {
      node2 = Objects.requireNonNull(
          SupplierBrokenFragmentWalkingCircularDependencyModel_Sting_MyModel1.create(node1()));
    }
    assert null != node2;
    return node2;
  }
