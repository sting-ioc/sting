...
public final class Sting_com_example_interceptor_AroundMetadataModel_Model_Service_InterceptorProxy
    implements AroundMetadataModel.Service {
  @Nonnull
  ...
  public static Object create(final Object target, final Object interceptor1) {
    return new Sting_com_example_interceptor_AroundMetadataModel_Model_Service_InterceptorProxy(
        (AroundMetadataModel.Service) target, (AroundMetadataModel.TraceInterceptor) interceptor1);
  }
  ...
  private Object invoke_run_interceptor2(@Nonnull final Object[] arguments) throws Throwable {
    ...
    final Invocation invocation =
        new Invocation(nextArguments -> invoke_run_target(nextArguments), arguments);
    result = (String) _interceptor1.around(
        invocation,
        "com.example.interceptor.AroundMetadataModel.Service",
        "run",
        "metadata",
        7,
        arguments);
