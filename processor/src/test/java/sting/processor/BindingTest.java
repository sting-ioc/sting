...
public class BindingTest
{
    ...
    return new Object[][]
      {
        ...
        new Object[]{ "E",
                      ...
                      new TypeMirror[]{ mockTypeMirror( "com.biz.MyService" ) },
                      false,
                      new ServiceDescriptor[]{ dependency( ServiceDescriptor.Kind.INSTANCE,
                                                           "",
                                                           "com.biz.MyDep",
                                                           false ) },
        ...
        new Object[]{ "H",
                      ...
                      new TypeMirror[]{ mockTypeMirror( "com.biz.MyService" ) },
                      false,
                      new ServiceDescriptor[]{ dependency( ServiceDescriptor.Kind.SUPPLIER,
                                                           "",
                                                           "com.biz.Plugin",
                                                           false ) },
        ...
        new Object[]{ "I",
                      ...
                      new ServiceDescriptor[]{ dependency( ServiceDescriptor.Kind.INSTANCE,
                                                           ...
                                                           "com.biz.MyDep",
                                                           true ),
                                               dependency( ServiceDescriptor.Kind.INSTANCE,
                                                           "",
                                                           "com.biz.OtherDep",
                                                           false ) },
        ...
        new Object[]{ "J",
                      ...
                      new ServiceDescriptor[]{ dependency( ServiceDescriptor.Kind.INSTANCE,
                                                           ...
                                                           "com.biz.MyDep",
                                                           false ),
                                               dependency( ServiceDescriptor.Kind.SUPPLIER,
                                                           "Backend",
                                                           "com.biz.Plugin",
                                                           true ) },
  ...
  @Nonnull
  private ServiceDescriptor dependency( @Nonnull final ServiceDescriptor.Kind dependencyType,
                                        @Nonnull final String qualifier,
                                        @Nonnull final String type,
                                        final boolean optional )
  {
    return new ServiceDescriptor( dependencyType,
