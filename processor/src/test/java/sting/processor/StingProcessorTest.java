    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.fragment.provides.dependency.ParameterizedSupplierCollectionDependencyModel",
                      "@Fragment target must not have a method with a supplier collection that contains a parameterized type" },
        ...
        new Object[]{ "com.example.fragment.provides.dependency.RawSupplierCollectionDependencyModel",
                      "@Fragment target must not have a method with a supplier collection parameter that contains a raw java.util.function.Supplier type" },
        ...
        new Object[]{ "com.example.fragment.provides.dependency.WildcardSupplierCollectionDependencyModel",
                      "@Fragment target must not have a method with a supplier collection parameter with a wildcard type parameter" },
        ...
        new Object[]{ "com.example.injectable.dependency.ParameterizedSupplierCollectionDependencyModel",
                      "@Injectable target must not have a constructor with a supplier collection that contains a parameterized type" },
        ...
        new Object[]{ "com.example.injectable.dependency.RawSupplierCollectionDependencyModel",
                      "@Injectable target must not have a constructor with a supplier collection parameter that contains a raw java.util.function.Supplier type" },
        ...
        new Object[]{ "com.example.injectable.dependency.WildcardSupplierCollectionDependencyModel",
                      "@Injectable target must not have a constructor with a supplier collection parameter with a wildcard type parameter" },
        ...
        new Object[]{ "com.example.injector.dependency.ParameterizedSupplierCollectionDependencyModel",
                      "@Dependency target must not return a value with a supplier collection that contains a parameterized type" },
        ...
        new Object[]{ "com.example.injector.dependency.RawSupplierCollectionDependencyModel",
                      "@Dependency target must not return a value with a supplier collection parameter that contains a raw java.util.function.Supplier type" },
        ...
        new Object[]{ "com.example.injector.dependency.WildcardSupplierCollectionDependencyModel",
                      "@Dependency target must not return a value with a supplier collection parameter with a wildcard type parameter" },
