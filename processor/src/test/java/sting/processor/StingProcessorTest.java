    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.fragment.provides.dependency.ParameterizedSupplierCollectionDependencyModel",
                      "@Fragment target must not have a method with a supplier collection parameter that contains a parameterized type" },
        ...
        new Object[]{ "com.example.injectable.dependency.ParameterizedSupplierCollectionDependencyModel",
                      "@Injectable target must not have a constructor with a supplier collection parameter that contains a parameterized type" },
