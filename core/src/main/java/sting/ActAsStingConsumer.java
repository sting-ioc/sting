 ...
 * parameter usages of {@link sting.Named @Named}. This is an integration meta-annotation rather
 * than a component-defining Sting annotation.
 *
 * <p>When a type is annotated with an annotation meta-annotated by {@link ActAsStingConsumer},
 * Sting tolerates {@link sting.Named @Named} on constructor parameters without treating that type
 * as a Sting-managed component. The expectation is that another annotation processor will process
 * the type and make use of the qualifier information if present.</p>
 *
