...
### [v0.36](https://github.com/sting-ioc/sting/tree/v0.36) (2026-06-13) · [Full Changelog](https://github.com/sting-ioc/sting/compare/v0.35...v0.36)
...
### [v0.34](https://github.com/sting-ioc/sting/tree/v0.34) (2026-04-30) · [Full Changelog](https://github.com/sting-ioc/sting/compare/v0.33...v0.34) · [API Differences](https://sting-ioc.github.io/api-diff?key=sting&old=0.33&new=0.34)
...
### [v0.31](https://github.com/sting-ioc/sting/tree/v0.31) (2026-04-29) · [Full Changelog](https://github.com/sting-ioc/sting/compare/v0.30...v0.31)
...
* Add `Optional<T>`, `Supplier<Optional<T>>`, and `Collection<Supplier<Optional<T>>>` service requests for
  injectable constructors, fragment provider parameters, and injector outputs. `Collection<T>` requests may now
  consume optional bindings by omitting `null` values from the resulting collection.
...
* Add documentation for framework integration via `StingProvider` and `ActAsStingComponent` (see `docs/framework_integration.md`).
