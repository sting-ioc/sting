...
public final class CollectFluxChallengeBuildStats
{
    ...
    throws Exception
  {
    Gir.go( () -> {
      ...
      WorkspaceUtil.collectStatistics( Collections.singletonList( "sithtracker" ), branch -> true, false );
    } );
  }
                                   ...
                                   @Nonnull final String version )
  {
    ...
    WorkspaceUtil.runAfterBuild( context, initialBuildSuccess, () -> {
      Buildr.patchBuildYmlDependency( context.appDirectory, "org.realityforge.sting", version );
